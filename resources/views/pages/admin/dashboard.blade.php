        ...
        <div class="col-span-12 mt-6">
            <div class="intro-y block sm:flex items-center h-10">
                ...
                <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                    <button class="button box flex items-center text-gray-700 dark:text-gray-300"> <i
            ...
            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                <table class="table table-report sm:mt-2">
                    <thead>
                        <tr>
                            <th class="whitespace-no-wrap">MENGUNDANG</th>
                            <th class="whitespace-no-wrap">NAMA LENGKAP</th>
                            <th class="text-center whitespace-no-wrap">JUMLAH TERUNDANG</th>
                            <th class="text-center whitespace-no-wrap">KODE REFFERENSI</th>
                            <th class="text-center whitespace-no-wrap">DIUNDANG OLEH</th>
                        </tr>
                    </thead>
                    <tbody>
